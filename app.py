...
# Set app title
st.title("Spain Wikipedia Sentiment Analysis")

st.markdown("""
This app analyzes the sentiment of user input based on content scraped from the **Spain Wikipedia page**.
""")

# Scrape Wikipedia content
@st.cache_data
def get_wikipedia_content(url="https://en.wikipedia.org/wiki/Spain"):
...
if user_input:
    ...
    # Optional: load trained model and predict (if you have models)
...
st.subheader("📌 About")
st.markdown("""
- This app scrapes and analyzes the **Wikipedia page of Spain**
